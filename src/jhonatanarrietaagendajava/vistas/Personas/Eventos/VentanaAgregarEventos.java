 ...
 */
package jhonatanarrietaagendajava.vistas.Personas.Eventos;
 ...
 * @author jhonda
 */
public class VentanaAgregarEventos extends JDialog {

    public VentanaAgregarEventos(VentanaPrincipal ventanaPrincipal) {
